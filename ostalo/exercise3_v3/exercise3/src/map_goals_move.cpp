...
void markerCallback(const visualization_msgs::MarkerArray& msg_marker){
  ROS_INFO("marker callback: x:%f y:%f",msg_marker.markers[0].pose.position.x,msg_marker.markers[0].pose.position.y);
}
void location();
