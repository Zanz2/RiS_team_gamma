  ...
  if (cloud_cylinder->points.empty ())
{
  ...
  marker.pose.position.x = cylinder_marker_array_x[counter_index];
  marker.pose.position.y = cylinder_marker_array_y[counter_index];
  marker.color.r=0.0f; // r value
  marker.color.g=1.0f; // g value
  marker.color.b=0.0f; // b value
